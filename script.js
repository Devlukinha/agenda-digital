...
// object - atividade nesse código é um objeto {}
// coletando dados
...
//processando dados
//template literas - (trocar algumas coisas com o sinal $)
//arroe function:
const criarItemDeAtividade = (atividade) => {

    let input = '<input onchange="concluirAtividade(event)" value="${atividade.data}" type="checkbox" '

    //verificando se a atividade foi finalizada
    // se for true passa nesse código abaixo, senão elimina
...
section.innerHTML = ''
//verificar se  a listta está vazia
if(atividades.length == 0){
    section.innerHTML = `<p>Nenhum atividade cadastrada</p>`
    return
}
// para cada atividade  descrita, vamos selecionar uma que está em atividades no array. Usando for teremos um loop
...
// começa a contar a partir de 6 da manhã e verifica se é menor que 23hr
    for(let i = 6; i < 23; i++) {
